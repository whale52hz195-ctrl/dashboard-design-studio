...
const giftsData = [
  ...
  },
  {
    ...
    image: "https://media.giphy.com/media/l4JzYya9yMxAi6jSyC/giphy.gif",
    category: "SVGA Magic-Make Gifts",
    price: 70,
    status: "Active",
    featured: false,
  ...
  },
  {
    ...
    image: "https://media.giphy.com/media/3o7aD4Zp9d8i2i2Q2A/giphy.gif",
    category: "SVGA Magic-Make Gifts",
    price: 85,
    status: "Active",
    featured: false,
  ...
  {
    name: "Rainbow Burst",
    image: "https://media.giphy.com/media/26BRvppThBZI8gr9q/giphy.gif",
    category: "SVGA Magic-Make Gifts",
    price: 110,
    status: "Active",
    featured: false,
...
async function uploadGifts() {
  try {
    ...
    // Summary by type
    const typeSummary = giftsData.reduce((acc, gift) => {
